...
{
    private Dictionary<int, RPGBestiary> entries = new Dictionary<int, RPGBestiary>();
    private RPGBestiary currentEntry;
    ...
    public override void Initialize()
    {
        ...
        // RPGBuilderEditor.Instance.InitializeFilters(RPGBuilderEditor.Instance.EditorFilters.bestiaryFilters);
    }
    ...
    {
        Dictionary<int, RPGBestiary> dictionary = new Dictionary<int, RPGBestiary>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGBestiary>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath + AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGBestiary>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGBestiary entryFile = (RPGBestiary) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        GUILayout.Space(10);
        GUILayout.Label("RPGBestiary - Full RPG Extended Features", EditorStyles.boldLabel);
        GUILayout.Space(5);
