...
public class RPGBuilderEditorWeatherModule : RPGBuilderEditorModule
{
    private Dictionary<int, RPGWeather> entries = new Dictionary<int, RPGWeather>();
    private RPGWeather currentEntry;
    ...
    public override void Initialize()
    {
        ...
        // RPGBuilderEditor.Instance.InitializeFilters(RPGBuilderEditor.Instance.EditorFilters.weatherFilters);
    }
    ...
    {
        Dictionary<int, RPGWeather> dictionary = new Dictionary<int, RPGWeather>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGWeather>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath + AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGWeather>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGWeather entryFile = (RPGWeather) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        GUILayout.Space(10);
        GUILayout.Label("RPGWeather - Full RPG Extended Features", EditorStyles.boldLabel);
        GUILayout.Space(5);
