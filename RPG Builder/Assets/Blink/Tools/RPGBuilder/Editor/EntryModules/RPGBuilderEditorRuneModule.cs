...
{
    private Dictionary<int, RPGRune> entries = new Dictionary<int, RPGRune>();
    private RPGRune currentEntry;
    ...
    public override void Initialize()
    {
        ...
        // RPGBuilderEditor.Instance.InitializeFilters(RPGBuilderEditor.Instance.EditorFilters.runeFilters);
    }
    ...
    {
        Dictionary<int, RPGRune> dictionary = new Dictionary<int, RPGRune>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGRune>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath + AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGRune>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGRune entryFile = (RPGRune) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        GUILayout.Space(10);
        GUILayout.Label("RPGRune - Full RPG Extended Features", EditorStyles.boldLabel);
        GUILayout.Space(5);
