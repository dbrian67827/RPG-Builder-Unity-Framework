...
{
    private Dictionary<int, RPGLore> entries = new Dictionary<int, RPGLore>();
    private RPGLore currentEntry;
    ...
    public override void Initialize()
    {
        ...
        // RPGBuilderEditor.Instance.InitializeFilters(RPGBuilderEditor.Instance.EditorFilters.loreFilters);
    }
    ...
    {
        Dictionary<int, RPGLore> dictionary = new Dictionary<int, RPGLore>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGLore>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath + AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGLore>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGLore entryFile = (RPGLore) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        GUILayout.Space(10);
        GUILayout.Label("RPGLore - Full RPG Extended Features", EditorStyles.boldLabel);
        GUILayout.Space(5);
