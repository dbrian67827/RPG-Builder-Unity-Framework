...
public class RPGBuilderEditorMailTemplateModule : RPGBuilderEditorModule
{
    private Dictionary<int, RPGMailTemplate> entries = new Dictionary<int, RPGMailTemplate>();
    private RPGMailTemplate currentEntry;
    ...
    public override void Initialize()
    {
        ...
        // RPGBuilderEditor.Instance.InitializeFilters(RPGBuilderEditor.Instance.EditorFilters.mailTemplateFilters);
    }
    ...
    {
        Dictionary<int, RPGMailTemplate> dictionary = new Dictionary<int, RPGMailTemplate>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGMailTemplate>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath + AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGMailTemplate>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGMailTemplate entryFile = (RPGMailTemplate) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        GUILayout.Space(10);
        GUILayout.Label("RPGMailTemplate - Full RPG Extended Features", EditorStyles.boldLabel);
        GUILayout.Space(5);
