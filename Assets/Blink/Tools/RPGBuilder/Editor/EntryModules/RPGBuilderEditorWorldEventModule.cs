...
public class RPGBuilderEditorWorldEventModule : RPGBuilderEditorModule
{
    private Dictionary<int, RPGWorldEvent> entries = new Dictionary<int, RPGWorldEvent>();
    private RPGWorldEvent currentEntry;
    ...
    public override void Initialize()
    {
        ...
        // RPGBuilderEditor.Instance.InitializeFilters(RPGBuilderEditor.Instance.EditorFilters.worldEventFilters);
    }
    ...
    {
        Dictionary<int, RPGWorldEvent> dictionary = new Dictionary<int, RPGWorldEvent>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGWorldEvent>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath + AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGWorldEvent>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGWorldEvent entryFile = (RPGWorldEvent) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        GUILayout.Space(10);
        GUILayout.Label("RPGWorldEvent - Full RPG Extended Features", EditorStyles.boldLabel);
        GUILayout.Space(5);
