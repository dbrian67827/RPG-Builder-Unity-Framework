...
{
    private Dictionary<int, RPGShop> entries = new Dictionary<int, RPGShop>();
    private RPGShop currentEntry;
    ...
    public override void Initialize()
    {
        ...
        // RPGBuilderEditor.Instance.InitializeFilters(RPGBuilderEditor.Instance.EditorFilters.shopFilters);
    }
    ...
    {
        Dictionary<int, RPGShop> dictionary = new Dictionary<int, RPGShop>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGShop>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath + AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGShop>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGShop entryFile = (RPGShop) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        GUILayout.Space(10);
        GUILayout.Label("RPGShop - Full RPG Extended Features", EditorStyles.boldLabel);
        GUILayout.Space(5);
