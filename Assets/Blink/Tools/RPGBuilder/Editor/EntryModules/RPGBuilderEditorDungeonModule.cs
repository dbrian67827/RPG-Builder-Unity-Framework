...
public class RPGBuilderEditorDungeonModule : RPGBuilderEditorModule
{
    private Dictionary<int, RPGDungeon> entries = new Dictionary<int, RPGDungeon>();
    private RPGDungeon currentEntry;
    ...
    public override void Initialize()
    {
        ...
        // RPGBuilderEditor.Instance.InitializeFilters(RPGBuilderEditor.Instance.EditorFilters.dungeonFilters);
    }
    ...
    {
        Dictionary<int, RPGDungeon> dictionary = new Dictionary<int, RPGDungeon>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGDungeon>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath + AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGDungeon>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGDungeon entryFile = (RPGDungeon) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        GUILayout.Space(10);
        GUILayout.Label("RPGDungeon - Full RPG Extended Features", EditorStyles.boldLabel);
        GUILayout.Space(5);
