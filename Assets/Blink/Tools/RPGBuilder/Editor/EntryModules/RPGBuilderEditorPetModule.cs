...
{
    private Dictionary<int, RPGPet> entries = new Dictionary<int, RPGPet>();
    private RPGPet currentEntry;
    ...
    public override void Initialize()
    {
        ...
        // RPGBuilderEditor.Instance.InitializeFilters(RPGBuilderEditor.Instance.EditorFilters.petFilters);
    }
    ...
    {
        Dictionary<int, RPGPet> dictionary = new Dictionary<int, RPGPet>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGPet>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath + AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGPet>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGPet entryFile = (RPGPet) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        GUILayout.Space(10);
        GUILayout.Label("RPGPet - Full RPG Extended Features", EditorStyles.boldLabel);
        GUILayout.Space(5);
