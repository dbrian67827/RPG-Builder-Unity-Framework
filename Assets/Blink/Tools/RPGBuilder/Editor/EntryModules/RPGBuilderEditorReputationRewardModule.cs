...
public class RPGBuilderEditorReputationRewardModule : RPGBuilderEditorModule
{
    private Dictionary<int, RPGReputationReward> entries = new Dictionary<int, RPGReputationReward>();
    private RPGReputationReward currentEntry;
    ...
    public override void Initialize()
    {
        ...
        // RPGBuilderEditor.Instance.InitializeFilters(RPGBuilderEditor.Instance.EditorFilters.reputationRewardFilters);
    }
    ...
    {
        Dictionary<int, RPGReputationReward> dictionary = new Dictionary<int, RPGReputationReward>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGReputationReward>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath + AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGReputationReward>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGReputationReward entryFile = (RPGReputationReward) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        GUILayout.Space(10);
        GUILayout.Label("RPGReputationReward - Full RPG Extended Features", EditorStyles.boldLabel);
        GUILayout.Space(5);
