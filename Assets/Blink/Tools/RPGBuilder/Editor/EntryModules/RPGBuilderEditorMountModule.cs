...
public class RPGBuilderEditorMountModule : RPGBuilderEditorModule
{
    private Dictionary<int, RPGMount> entries = new Dictionary<int, RPGMount>();
    private RPGMount currentEntry;
    ...
    public override void Initialize()
    {
        ...
        // RPGBuilderEditor.Instance.InitializeFilters(RPGBuilderEditor.Instance.EditorFilters.mountFilters);
    }
    ...
    {
        Dictionary<int, RPGMount> dictionary = new Dictionary<int, RPGMount>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGMount>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath + AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGMount>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGMount entryFile = (RPGMount) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        GUILayout.Space(10);
        GUILayout.Label("RPGMount - Full RPG Extended Features", EditorStyles.boldLabel);
        GUILayout.Space(5);
