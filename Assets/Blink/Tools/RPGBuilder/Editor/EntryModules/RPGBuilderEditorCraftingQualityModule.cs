...
public class RPGBuilderEditorCraftingQualityModule : RPGBuilderEditorModule
{
    private Dictionary<int, RPGCraftingQuality> entries = new Dictionary<int, RPGCraftingQuality>();
    private RPGCraftingQuality currentEntry;
    ...
    public override void Initialize()
    {
        ...
        // RPGBuilderEditor.Instance.InitializeFilters(RPGBuilderEditor.Instance.EditorFilters.craftingQualityFilters);
    }
    ...
    {
        Dictionary<int, RPGCraftingQuality> dictionary = new Dictionary<int, RPGCraftingQuality>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGCraftingQuality>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath + AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGCraftingQuality>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGCraftingQuality entryFile = (RPGCraftingQuality) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        GUILayout.Space(10);
        GUILayout.Label("RPGCraftingQuality - Full RPG Extended Features", EditorStyles.boldLabel);
        GUILayout.Space(5);
