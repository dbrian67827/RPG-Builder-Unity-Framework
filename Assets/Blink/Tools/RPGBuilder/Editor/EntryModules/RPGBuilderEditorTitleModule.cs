...
{
    private Dictionary<int, RPGTitle> entries = new Dictionary<int, RPGTitle>();
    private RPGTitle currentEntry;
    ...
    public override void Initialize()
    {
        ...
        // RPGBuilderEditor.Instance.InitializeFilters(RPGBuilderEditor.Instance.EditorFilters.titleFilters);
    }
    ...
    {
        Dictionary<int, RPGTitle> dictionary = new Dictionary<int, RPGTitle>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGTitle>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath + AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGTitle>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGTitle entryFile = (RPGTitle) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        GUILayout.Space(10);
        GUILayout.Label("RPGTitle - Full RPG Extended Features", EditorStyles.boldLabel);
        GUILayout.Space(5);
