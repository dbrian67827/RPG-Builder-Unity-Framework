...
public class RPGBuilderEditorTransmogModule : RPGBuilderEditorModule
{
    private Dictionary<int, RPGTransmog> entries = new Dictionary<int, RPGTransmog>();
    private RPGTransmog currentEntry;
    ...
    public override void Initialize()
    {
        ...
        // RPGBuilderEditor.Instance.InitializeFilters(RPGBuilderEditor.Instance.EditorFilters.transmogFilters);
    }
    ...
    {
        Dictionary<int, RPGTransmog> dictionary = new Dictionary<int, RPGTransmog>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGTransmog>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath + AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGTransmog>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGTransmog entryFile = (RPGTransmog) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        GUILayout.Space(10);
        GUILayout.Label("RPGTransmog - Full RPG Extended Features", EditorStyles.boldLabel);
        GUILayout.Space(5);
