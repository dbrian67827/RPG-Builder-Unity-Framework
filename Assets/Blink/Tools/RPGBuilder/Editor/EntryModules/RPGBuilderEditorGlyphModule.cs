...
{
    private Dictionary<int, RPGGlyph> entries = new Dictionary<int, RPGGlyph>();
    private RPGGlyph currentEntry;
    ...
    public override void Initialize()
    {
        ...
        // RPGBuilderEditor.Instance.InitializeFilters(RPGBuilderEditor.Instance.EditorFilters.glyphFilters);
    }
    ...
    {
        Dictionary<int, RPGGlyph> dictionary = new Dictionary<int, RPGGlyph>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGGlyph>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath + AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGGlyph>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGGlyph entryFile = (RPGGlyph) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        GUILayout.Space(10);
        GUILayout.Label("RPGGlyph - Full RPG Extended Features", EditorStyles.boldLabel);
        GUILayout.Space(5);
