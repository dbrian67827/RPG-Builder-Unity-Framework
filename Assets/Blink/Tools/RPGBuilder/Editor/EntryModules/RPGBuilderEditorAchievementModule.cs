...
public class RPGBuilderEditorAchievementModule : RPGBuilderEditorModule
{
    private Dictionary<int, RPGAchievement> entries = new Dictionary<int, RPGAchievement>();
    private RPGAchievement currentEntry;
    ...
    public override void Initialize()
    {
        ...
        // RPGBuilderEditor.Instance.InitializeFilters(RPGBuilderEditor.Instance.EditorFilters.achievementFilters);
    }
    ...
    {
        Dictionary<int, RPGAchievement> dictionary = new Dictionary<int, RPGAchievement>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGAchievement>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath + AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGAchievement>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGAchievement entryFile = (RPGAchievement) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        GUILayout.Space(10);
        GUILayout.Label("RPGAchievement - Full RPG Extended Features", EditorStyles.boldLabel);
        GUILayout.Space(5);
